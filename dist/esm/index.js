...
export default function (api) {
  ...
  var decoratorPath = path.join(PluginKey, 'decorator.tpl');
  var wrappedRoutes = [];
  api.describe({
    key: PluginKey
  });
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var exists;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          exists = fs.existsSync(path.join(tempDirPath, decoratorPath));
          if (!exists) {
            _context.next = 3;
            break;
          }
        ...
        case 3:
          ...
          api.writeTmpFile({
            path: 'index.ts',
            content: "\nexport {MultistageRoute} from 'umi-plugin-multistage-route/dist/cjs/types';\n"
          });
          wrappedRoutes.forEach(function (item) {
            api.writeTmpFile({
              path: item.path,
  ...
  api.onPatchRoute( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref2) {
      var route, outFileName, outPath, routePath;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            outFileName = route.absPath.replace(/\//g, '-').replace(/:/, '_').replace(/^-/, '') + '.ts';
            outPath = path.join('wrapper', outFileName);
